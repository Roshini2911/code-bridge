...
import ClassBookingPage from "./member/ClassBookingPage";
...
export default function MemberDashboard() {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case "fitness-classes": return <ClassBookingPage />;
      case "book-class": return <ClassBookingPage />;
      case "my-bookings": return <ClassBookingPage />;
